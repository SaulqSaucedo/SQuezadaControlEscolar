...
namespace DL_EF
{
    ...
    public partial class SQuezadaControlEscolarEntities : DbContext
    {
        public SQuezadaControlEscolarEntities()
            : base("name=SQuezadaControlEscolarEntities")
        {
        }
        ...
        public virtual ObjectResult<MateriaGetNoAsignadas_Result> MateriaGetNoAsignadas(Nullable<int> idAlumno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MateriaGetNoAsignadas_Result>("MateriaGetNoAsignadas", idAlumnoParameter);
        }
        ...
        public virtual ObjectResult<AlumnoMateriaGetAll_Result> AlumnoMateriaGetAll(Nullable<int> idAlumnoMateria)
        {
            var idAlumnoMateriaParameter = idAlumnoMateria.HasValue ?
                new ObjectParameter("IdAlumnoMateria", idAlumnoMateria) :
                new ObjectParameter("IdAlumnoMateria", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AlumnoMateriaGetAll_Result>("AlumnoMateriaGetAll", idAlumnoMateriaParameter);
        }
    }
}
